namespace Keras.Layers
{
    ...
    public class BatchNormalization : BaseLayer
    {
        ...
        ///     Conv2D layer with data_format="channels_first", set axis=1 in BatchNormalization.
        /// </param>
        ...
        /// <param name="scale">
        ///     If True, multiply by gamma. If False, gamma is not used. When the next layer is linear (also e.g.
        ...
        public BatchNormalization(int axis = -1, float momentum = 0.99f, float epsilon = 0.001f, bool center = true,
            bool scale = true, string beta_initializer = "zeros",
            string gamma_initializer = "ones", string moving_mean_initializer = "zeros",
            string moving_variance_initializer = "ones",
            string beta_regularizer = null, string gamma_regularizer = null, string beta_constraint = null,
            string gamma_constraint = null, Shape input_shape = null)

        {
            if (input_shape != null)
                PyInstance = Instance.keras.layers.BatchNormalization(axis: axis, momentum: momentum, epsilon: epsilon,
                    center: center,
