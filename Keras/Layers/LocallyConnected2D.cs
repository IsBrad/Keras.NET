...
namespace Keras.Layers
{
    ...
    ///     The LocallyConnected2D layer works similarly to the Conv2D layer, except that weights are unshared, that is, a
    ...
    public class LocallyConnected2D : BaseLayer
    {
        ...
        /// </param>
        public LocallyConnected2D(int filters, Tuple<int, int> kernel_size, Tuple<int, int> strides = null,
