namespace Keras.Layers
{
    public class CuDNNLSTM : RNN
    {
        ...
        /// </param>
        public CuDNNLSTM(int units, string kernel_initializer = "glorot_uniform",
            ...
            string bias_regularizer = "", string activity_regularizer = "",
            string kernel_constraint = "", string recurrent_constraint = "", string bias_constraint = "",
