namespace Keras.Layers
{
    ...
    public class Embedding : BaseLayer
    {
        ...
        public Embedding(int input_dim, int output_dim, string embeddings_initializer = "uniform",
            string embeddings_regularizer = "",
            string activity_regularizer = "", string embeddings_constraint = "", bool mask_zero = false,
            int? input_length = null, Shape input_shape = null)
        {
