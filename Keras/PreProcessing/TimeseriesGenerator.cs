...
namespace Keras.PreProcessing
{
    ...
    ///     This class takes in a sequence of data-points gathered at equal intervals, along with time series parameters such
    ///     as stride, length of history, etc.,
    ///     to produce batches for training/validation.
    /// </summary>
    /// <seealso cref="Keras.Base" />
    public class TimeseriesGenerator : Sequence
    {
        /// <summary>
        ...
        public TimeseriesGenerator(NDarray data, NDarray targets, int length, int sampling_rate = 1, int stride = 1,
            int start_index = 0, int? end_index = null, bool shuffle = false, bool reverse = false,
            int batch_size = 128)
        {
